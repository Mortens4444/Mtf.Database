...
public static class ResourceHelper
{
    public static string GetDbScript(string scriptName) =>
        ReadEmbeddedResource(String.Concat(BaseRepository.DatabaseScriptsLocation ?? "Database.Scripts", ".", scriptName, ".sql"), Encoding.UTF8);
    ...
    public static Stream GetEmbeddedResourceStream(string resourceName, Assembly assembly)
        ...
        throw new ArgumentException($"Resource '{resourceName}' not found in assembly '{assembly?.FullName ?? "N/A"}'.", nameof(resourceName));
